            ...
            <main className={!isIntro2 ? 'story-one' : 'story-two'}>
                ...
                <div className={`step game ${4 === step ? 'show' : ''} speak-mode`} ref={gameContainer}>
                    ...
                    <div className="leftImages" ref={imgLeftContainer}>
                        <img src="./img/chat/01_telepohne.png" className="answer_illu" />
                        <img src="./img/chat/02_sonnette.png" className="answer_illu" />
                        <img src="./img/chat/04_yeux.png" className="answer_illu" />
                    </div>
                    ...
                    <div className="rightImages" ref={imgRightContainer}>
                        <img src="./img/chat/01_telepohne.png" className="answer_illu" />
                        <img src="./img/chat/02_sonnette.png" className="answer_illu" />
                        <img src="./img/chat/03_yeux.png" className="answer_illu" />
                    </div>
                </div>
                {/* CONCLUSION */}
